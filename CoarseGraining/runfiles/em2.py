...
lamb0 = martini_hoomd.set_pairs(table_dir = "lambda0.5-martinitim",nl=nl)
#lamb0 = martini_hoomd.set_pairs(table_dir = "lambda0.5-martinifull",nl=nl)
...
# Output parameters
hoomd.analyze.log(filename = "em2.log", 
