...
#area_per_lipid = float(options.area_per_lipid)
print ('Area per lipid: {}'.format(options.area_per_lipid))
print ('Rotation: {}'.format(options.rotation))
#os.system('init-bilayer_tilted.py -a {} --DSPC {} --DPPC {} --acid16 {} --acid22 {} --alc12 {} --alc14
#    {} --alc16 {} --alc18 {} --alc20 {} --alc22 {} --alc24 {} --ISIS {} --SS {} --CHOL {} --PMEA {}
#    --water {}'.format( options ))
...
#    system = System(box=bilayer.box, gbbs=bilayer.molecules)
    ...
    mygbb = Gbb() 
    mygbb.load_lammps_data(data_file=(options.filename+'.lammpsdata'))
    system.print_grodata(resid_atom_list, mygbb=mygbb,
            filename=(options.filename+'.gro'), ff_param_set='gromos53a6')
